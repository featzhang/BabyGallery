package club.guadazi.babygallery.util.yueyueniao;
...
import club.guadazi.babygallery.view.BabyGalleryApplication;
...
public class ImageManager2 {
    ...
    private static BabyGalleryApplication myapp;
    ...
    public static ImageManager2 from(Context context) {
        ...
        if (myapp == null) {
            myapp = (BabyGalleryApplication) context.getApplicationContext();
        }
